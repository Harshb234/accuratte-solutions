        ...
        <section className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 py-16 relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 mt-2 text-sm">Sign in to your Accuratte account</p>
                </div>
                ...
                <div style={{
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                            <label style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#475569', cursor: 'pointer' }}>
                                <input type="checkbox" checked={remember} onChange={() => setRemember(!remember)} style={{ accentColor: '#0099ff' }} />
                                Remember me
                            </label>
                            <Link to="/contact" style={{ fontSize: '13px', color: '#0099ff', fontWeight: 600, textDecoration: 'none' }}>Forgot password?</Link>
                        </div>
                    ...
                    <p style={{ textAlign: 'center', fontSize: '13px', color: '#64748b', marginTop: '20px' }}>
                        Don't have an account? <Link to="/signup" style={{ color: '#0099ff', fontWeight: 700, textDecoration: 'none' }}>Sign up for free</Link>
                    </p>
                </div>
            </motion.div>
